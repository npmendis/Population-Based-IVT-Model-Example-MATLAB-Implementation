...
The code simulates the concentration-time profiles of runoff RNA and total abortive products using the optimized model parameters reported in the manuscript. Three experimental conditions with different NTP and Mg concentrations are simulated and compared with the corresponding experimental data. This implementation is provided as an example for model simulation.
